            ...
            <div class="card border-0 shadow-sm">
                <div class="card-body">
                    ...
                    <div class="list-group list-group-flush">
                        <a href="<?php echo BASE_URL; ?>buyer/dashboard.php" class="list-group-item list-group-item-action active">
                            <i class="fas fa-tachometer-alt me-2"></i> Dashboard
                        </a>
                        <a href="<?php echo BASE_URL; ?>buyer/browse.php" class="list-group-item list-group-item-action">
                            <i class="fas fa-search me-2"></i> Browse Pets
                        </a>
                        <a href="<?php echo BASE_URL; ?>buyer/browse.php?type=product" class="list-group-item list-group-item-action">
